...
async def create_location(
    ...
    location = await service.create_location(location_data, None)
    return location
...
async def update_location(
    ...
    location = await service.update_location(location_id, location_data, None)
    return location
...
async def delete_location(
    ...
    result = await service.delete_location(location_id, None)
    return result