...
from src.locations.schemas import LocationRead
...
async def create_new_location(
    ...
    return await create_location(db, name, address, location_type, user)
...
async def edit_location(
    ...
    return await update_location(db, location_id, name, address, location_type, user)
